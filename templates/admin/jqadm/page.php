...
?>
<div class="aimeos test" lang="<?= $this->param( 'locale' ) ?>"
	...
	<nav class="main-sidebar">
		...
		<a class="logo"  href="/">
				<img src="{{asset('vendor/muhammad-nawlo/change-config-theme/assets/logo.jpeg')}}" alt="Hansa Store logo" title="Hasna Store logo">
			</a>
